...
* `yarn install` Install all packages in dependencies of the package.json, then run ``yarn upgrade`` Not working on all packages
	...
	Update: ***	`yarn remove @fortawesome/fontawesome-free autoprefixer bootstrap debug fullcalendar handlebars jquery postcss tailwindcss uikit && add @fortawesome/fontawesome-free autoprefixer bootstrap debug fullcalendar handlebars jquery postcss tailwindcss uikit && yarn remove @fullhuman/postcss-purgecss browser-sync del gulp gulp-autoprefixer gulp-clean-css gulp-compile-handlebars gulp-dart-sass gulp-if gulp-imagemin gulp-inject gulp-mode gulp-postcss gulp-rename gulp-replace gulp-uglify-es merge-stream postcss-import && yarn add @fullhuman/postcss-purgecss browser-sync del gulp gulp-autoprefixer gulp-clean-css gulp-compile-handlebars gulp-dart-sass gulp-if gulp-imagemin gulp-inject gulp-mode gulp-postcss gulp-rename gulp-replace gulp-uglify-es merge-stream postcss-import -D` *** or run one by one
