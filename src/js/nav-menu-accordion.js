...
function navMenu(targetMenu, btn, thisParentTagName, classThisParent, activeParentClassName, classToggle, classHiddenName, inactiveButton, inactiveSubNav, classActiveName, subNavTagName) {
  ...
  for (let i = 0; i < buttons.length; i++) {
    buttons[i].addEventListener('click', function() {
      ...
      //----- Normal: Close items in menu one by one -----
      ...
      let open = findFirstChild(this).classList.contains(classHiddenName) //It's Boolean. This Arrow right is hidden
      ...
      //--Close one item and close itself whole tree menu in the meantime--//
      // if (close == true) {
...
if (allExist(['#offcanvas', '#offcanvas li>.flex>a:nth-child(2)', 'LI', '.uk-parent', 'py-1', '.toggle', 'hidden', '#offcanvas li.py-1:not(.active) .flex>a:nth-child(2)', '#offcanvas li.py-1:not(.active) ul.toggle', 'active', 'UL']) == true) {
  navMenu('#offcanvas', '#offcanvas li>.flex>a:nth-child(2)', 'LI', '.uk-parent', 'py-1', '.toggle', 'hidden', '#offcanvas li.py-1:not(.active) .flex>a:nth-child(2)', '#offcanvas li.py-1:not(.active) ul.toggle', 'active', 'UL')
}
